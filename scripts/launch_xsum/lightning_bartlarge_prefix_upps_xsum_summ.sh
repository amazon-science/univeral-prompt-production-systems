...
cd ../.. && /home/ubuntu/anaconda3/envs/pytorch_p36/bin/python3 -u run_lightning.py --do_train --do_eval --use_lightning \
      --model_variation bart_prefix_universal_production_system --model_name_or_path facebook/bart-large \
      ...
      --preprocessing_num_workers 64 --max_source_length 768 --max_target_length 62 \
