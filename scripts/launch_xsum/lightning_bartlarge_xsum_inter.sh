cd ../.. && /home/ubuntu/anaconda3/envs/pytorch_p36/bin/python3 -u run_lightning.py --do_train --do_eval --use_lightning \
      ...
      --output_dir /home/ubuntu/Models/prompt_rule_gen/bartlarge_xsum_inter --report_to none \
      --tasks_file_path ./task_files/xsum_inter_all.yml --num_train_epochs 5 --disable_exp_logger \
