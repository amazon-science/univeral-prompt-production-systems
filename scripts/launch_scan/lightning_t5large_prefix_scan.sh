...
cd ../.. && /home/ubuntu/anaconda3/envs/pytorch_p36/bin/python3 -u run_lightning.py --do_train --do_eval --use_lightning \
	--model_variation t5_prefix --model_name_or_path facebook/bart-large --output_dir /home/ubuntu/Models/prompt_rule_gen/bartlarge_prefix_xsum_summ \
	--tasks_file_path ./task_files/xsum_summ_lisa.yml --num_train_epochs 30 --disable_exp_logger --learning_rate 5e-5 \
	...
	--max_descriptor_length 10 --seed 101 --num_beams 6  --val_max_target_length 200 --max_eval_samples 1000 --length_penalty 2 \
