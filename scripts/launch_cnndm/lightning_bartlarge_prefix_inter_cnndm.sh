...
cd ../.. && /home/ubuntu/anaconda3/envs/pytorch_p36/bin/python3 -u run_lightning.py --do_train --do_eval --use_lightning \
	--model_variation bart_prefix --model_name_or_path facebook/bart-large \
	--config_name facebook/bart-large-xsum --tokenizer_name facebook/bart-large-xsum \
	--output_dir /home/Models/prompt_rule_gen/bartlarge_prefix_inter_cnndm --report_to none \
	--tasks_file_path ./task_files/cnndm_inter_all.yml --num_train_epochs 5 --disable_exp_logger --learning_rate 3e-5 \
	...
	--max_descriptor_length 10 --seed 1 --num_beams 3 --val_max_target_length 62 --max_eval_samples 1000 --length_penalty 1 \
