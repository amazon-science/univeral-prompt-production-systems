...
@register_model
class _Bart_Prefix_ProdSys(BartForConditionalGeneration):
    """
    _Bart_Prefix_NPS is very similar to `BartForConditionalGeneration` with a few differences to
    handle the field `descriptors` in the methods below.
    """
    def __init__(self, config, **kwargs):
        super(_Bart_Prefix_ProdSys, self).__init__(config)
