...
@register_model
class _T5_Prefix_Trsf(T5ForConditionalGeneration):
    """
    _T5_Prefix_Trsf is very similar to `T5ForConditionalGeneration` with a few differences to
    handle the field `descriptors` in the methods below.
    """
    def __init__(self, config, **kwargs):
        super(_T5_Prefix_Trsf, self).__init__(config)
